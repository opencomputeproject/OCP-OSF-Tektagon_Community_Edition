...
static int PfmFlashVerifyWrapper (struct manifest *pfm, struct hash_engine *hash,
...
static int PfmFlashGetIdWrapper (struct manifest *pfm, uint32_t *id)
{
	struct pfm_flash *pfm_flash = (struct pfm_flash*) pfm;
...
static int PfmFlashGetPlatformIdWrapper (struct manifest *pfm, char **id, size_t length)
{
	struct pfm_flash *pfm_flash = (struct pfm_flash*) pfm;
...
static int PfmFlashGetHashWrapper (struct manifest *pfm, struct hash_engine *hash, uint8_t *hash_out,
	size_t hash_length)
{
	struct pfm_flash *pfm_flash = (struct pfm_flash*) pfm;
...
static int PfmFlashGetSignatureWrapper (struct manifest *pfm, uint8_t *signature, size_t length)
{
	struct pfm_flash *pfm_flash = (struct pfm_flash*) pfm;
...
static void PfmFlashFreeFirmwareWrapper (struct pfm *pfm, struct pfm_firmware *fw)
{
	size_t i;
...
static int PfmFlashBufferSupportedVersionsWrapper (struct pfm *pfm, const char *fw, size_t offset,
...
static void PfmFlashGetFirmwareImagesWrapper (struct pfm *pfm, struct pfm_image_list *img_list)
{
	size_t i;

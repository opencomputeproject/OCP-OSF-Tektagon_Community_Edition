...
MODE_2_LIST = [
    {
        ...
        "rsa": 2048,
        "sha": 256,
        "otp": "2600A3_RSA2048_SHA256.json"
    },
    {
        ...
        "rsa": 2048,
        "sha": 256,
        "otp": "2600A3_RSA2048_SHA256_o1.json"
    },
    {
        ...
        "rsa": 2048,
        "sha": 256,
        "otp": "2600A3_RSA2048_SHA256_o2_pub.json"
    },
    {
        ...
        "rsa": 2048,
        "sha": 256,
        "otp": "2600A3_RSA2048_SHA256_o2_priv.json"
    },
    {
        "name": "RSA3072_SHA384",
        "encrypt": False,
        "rsa": 3072,
        "sha": 384,
        "otp": "2600A3_RSA3072_SHA384.json"
    },
    {
        ...
        "rsa": 3072,
        "sha": 384,
        "otp": "2600A3_RSA3072_SHA384_o1.json"
    },
    {
        ...
        "rsa": 3072,
        "sha": 384,
        "otp": "2600A3_RSA3072_SHA384_o2_pub.json"
    },
    {
        ...
        "rsa": 3072,
        "sha": 384,
        "otp": "2600A3_RSA3072_SHA384_o2_priv.json"
    },
    {
        "name": "RSA4096_SHA512",
        "encrypt": False,
        "rsa": 4096,
        "sha": 512,
        "otp": "2600A3_RSA4096_SHA512.json"
    },
    {
        ...
        "rsa": 4096,
        "sha": 512,
        "otp": "2600A3_RSA4096_SHA512_o1.json"
    },
    {
        ...
        "rsa": 4096,
        "sha": 512,
        "otp": "2600A3_RSA4096_SHA512_o2_pub.json"
    },
    {
        ...
        "rsa": 4096,
        "sha": 512,
        "otp": "2600A3_RSA4096_SHA512_o2_priv.json"
    },
]
...
if __name__ == "__main__":
    ...
    key_folder = root_dir+'/boards/arm/ast2600_evb/key'
    aes_key_path = root_dir+'/boards/arm/ast2600_evb/key/test_aes_key.bin'
    ...
    for mode2 in MODE_2_LIST:
        ...
        otp_config = '{}/boards/arm/ast2600_evb/otp_config/{}'.format(
            root_dir, mode2['otp'])
        ...
        for kid in [0, 1, 2]:
            ...
            gen_uart_script = root_dir + \
                '/boards/arm/ast2600_evb/tools/gen_uart_booting_image.sh'

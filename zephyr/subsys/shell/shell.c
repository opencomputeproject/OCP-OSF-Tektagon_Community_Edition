		  ...
		  void *arg_log_level)
{
	...
	while (true) {
		...
		k_mutex_unlock(&shell->ctx->wr_mtx);
		//I2c_slave_dev_debug+>
		//add a routine in thread to test I2C command process.
		// if(gI2cSlaveProcess.InProcess)
		// {
		// 	printk("gI2cSlaveProcess.InProcess\n");
		// 	PchBmcProcessCommands(&gI2cSlaveProcess.DataBuf[0]);
		// }
//<+I2c_slave_dev_debug
	}
}

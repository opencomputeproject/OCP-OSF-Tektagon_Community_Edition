...
int test_gpio_callback_add_remove(void)
{
	ast_test_fail = 0;
	ast_zassert_equal(test_callback_add_remove(), TC_PASS, NULL);
	return ast_ztest_result();
}

int test_gpio_callback_self_remove(void)
{
	ast_test_fail = 0;
	ast_zassert_equal(test_callback_self_remove(), TC_PASS, NULL);
	return ast_ztest_result();
}

int test_gpio_callback_enable_disable(void)
{
	ast_test_fail = 0;
	ast_zassert_equal(test_callback_enable_disable(), TC_PASS, NULL);
	return ast_ztest_result();
}
